        ...
        if(bodyFound==False or parFound==False) and (".md" not in filePath):
            ...
            for i, word in enumerate(line.split()):
                ...
                if word in stopCheckingWords:
                    ...
                    stop=False
                if stop==False and word[0] != "#" and ((word in glossary) or (word[:-1] in glossary) or (word[:-2] in glossary and len(word[:-2]) > 0) 
                                    or (word[1:-1] in glossary and len(word[1:-1]) > 0) or (word[2:-2] in glossary and len(word[2:-2]) > 0) or (word[2:-3] in glossary and len(word[2:-3]) > 0)) and len(word)>1:
