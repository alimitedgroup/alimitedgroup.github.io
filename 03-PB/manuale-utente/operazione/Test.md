...
Per eseguire i tеst di unità ed integrazione è sufficiente aprire un prоmpt dei comandi (o _shell_) nella radice dell'installazione ed eseguire questi due comandi:
