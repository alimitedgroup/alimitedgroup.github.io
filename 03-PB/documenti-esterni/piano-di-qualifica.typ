...
#figure(
  table(
    ...
    [T-66-S], [Verificare che un Admin Globale possa visualizzare le notifiche suggerite da un Sistema _Machine Learning_], [R-66-F-Ob], [NI], //LOL
    [T-67-S], [Verificare che un Admin Globale, visualizzando l'elenco delle notifiche di rifornimento fornite da un Sistema _Machine Learning_, visualizzi l'ID di ciascuna notifica], [R-67-F-Ob], [S],
    [T-68-S], [Verificare che un Admin Globale, visualizzando l'elenco delle notifiche di rifornimento fornite da un Sistema _Machine Learning_, visualizzi lo stato di ciascuna notifica], [R-68-F-Ob], [S],
    ...
    [T-85-S], [Verificare che un Admin Globale riceva un errore quando cerca di esportare l'inventario dei magazzini ma nessun dato è disponibile], [R-85-F-Ob], [NI], //LOL
