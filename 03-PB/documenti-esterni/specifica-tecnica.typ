...
#figure(
  image("../../assets/order/GetTransferRequestDTO.png", width: 40%),
...
#figure(
  image("../../assets/order/Repo-Transfer.png", width: 45%),
...
#figure(
  image("../../assets/order/ContactWarehousesCmd.png", width: 35%),
