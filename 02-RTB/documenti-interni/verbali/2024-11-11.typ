...
Come scritto nell'ultimo #link("https://alimitedgroup.github.io/VI%2004-11-2024%20v1.0.0.pdf")[verbale interno] nella sezione "Esiti della riunione", _ALimitedGroup_ ha analizzato attentamente i requisiti richiesti nel #link("https://www.math.unipd.it/~tullio/IS-1/2024/Progetto/C6.pdf")[capitolato di presentazione] di #M31: è stato deciso di chiedere a quest'ultima ulteriori approfondimenti riguardo alla sezione "Requisiti Funzionali Minimi" su:
