...
I componenti di _ALimitedGroup_ hanno deciso di utilizzare, da ora in avanti, una convenzione riguardante la denominazione di _Branch_ e _Issue_.
\
...
Le *_Issue_* avranno una nomenclatura molto simile:
...
Il gruppo si è aggiornato sugli esiti del lavoro asincrono svolto e ha iniziato a mettere in forma definitiva tutto il materiale raccolto riguardante l'*Analisi dei Requisiti*, il *Piano di Progetto*, il *Glossario* e le *Norme di progetto*.
...
#align(center)[*#persona(p.samuele)* $arrow.r$ *Responsabile*]
#align(center)[*#persona(p.marco)* $arrow.r$ *Amministratore* \ *#persona(p.emanuele)* $arrow.r$ *Amministratore*\ *#persona(p.matteo)* $arrow.r$ *Amministratore*]
#align(center)[*#persona(p.sara)* $arrow.r$ *Analista* \ *#persona(p.loris)* $arrow.r$ *Analista*]
...
Agli *analisti* è dato il compito di proseguire l'*Analisi dei Requisiti*.
