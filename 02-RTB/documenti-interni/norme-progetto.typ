...
- *_GitHub#super[G]_*: per la gestione del _Backlog_ e il sistema di _ticketing_, utili per tenere traccia e sotto controllo quanto fatto e quanto è ancora da fare. GitHub#super[G] offre inoltre una visualizzazione specifica per avere dei diagrammi di Gantt, utili per fini di pianificazione;
...
Tale eseguibile dev'essere eseguito in automatico sia nell'ambiente locale di uno sviluppatore (possibilmente dopo l'azione di Save File) sia in ambiente di CI/CD tramite Github Action#super[G] che bloccano l'errata introduzione di codice non formattato secondo lo standard all'interno del branch#super[G] principale.
...
- *_GitHub#super[G]_*: il gruppo ha deciso di utilizzare il sistema di _ticketing_ e le _pull request#super[G]_ di _GitHub_#super[G] per permettere la redazione, Verifica#super[G] e approvazione#super[G] di tutti i documenti. Per ulteriori dettagli consultare la @infrastruttura.
...
Per assicurare qualità _ALimitedGroup_ eseguirà, come suggerito dallo standard _ISO/IEC 12207:1995_ attività di Verifica#super[G] (@verifica) e Validazione#super[G] (@capitolovalidazione).
