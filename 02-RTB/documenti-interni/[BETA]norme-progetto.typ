...
*Redattore* $arrow$ Analisti

*Destinatari* $arrow$ #M31, ALimitedGroup, #profBreve(p.tullio), #profBreve(p.cardin)
...
*Redattore* $arrow$ Amministratore

*Destinatari* $arrow$ ALimitedGroup, #profBreve(p.tullio), #profBreve(p.cardin)
...
*Redattore* $arrow$ Responsabile o Amministratore
