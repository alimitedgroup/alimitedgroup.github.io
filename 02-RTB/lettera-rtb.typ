...
Technology Baseline_ in data *19 febbraio 2025*, riguardo il lavoro svolto nell'ambito del progetto
...
#table(
  ...
  [
    ...
    - #link("https://alimitedgroup.github.io/PQ%20v1.0.0.pdf")[Piano di Qualifica v1.0.0];
...
Infine, riconfermiamo la data ultima di consegna del progetto al *31 marzo 2025*, con costo stimato massimo di *€12˙930*.
